...
- 📄 [مطالب درسی](https://github.com/PahlavanianAzadUni/computer-networks-notes/tree/main/Learning%20Resources)  
- 📄 [تحقیق و تمرین](https://github.com/PahlavanianAzadUni/computer-networks-notes/tree/main/Researches%20and%20Assignments)  
- 🎥 [ویدیو راهنما](https://www.aparat.com/v/nsxx351?refererRef=channel_page)  
...
1. **سوئیچینگ مداری** — [🔗 مشاهده درس 1](./Lesson1.md)  
2. **سوئیچینگ پیامی** — [🔗 مشاهده درس 2](./Lesson2.md)  
3. **سوئیچینگ سلولی (Packet)** — [🔗 مشاهده درس 3](./Lesson3.md)  
4. **مرور سوئیچینگ، مدار مجازی، دیتاگرام و سیگنال‌ها** — [🔗 مشاهده درس 4](./Lesson4.md)  
5. **رسانه‌های انتقال، امواج و انتشار بی‌سیم** — [🔗 مشاهده درس 5](./Lesson5.md)  
6. **لایه داده (لایه ۲)** — [🔗 مشاهده درس 6](./Lesson6.md)  
7A. **کنترل خطا (عمقی)، کد هامینگ، CRC** — [🔗 مشاهده درس 7A](./Lesson7A.md)  
7B. **بررسی کامل کنترل جریان** — [🔗 مشاهده درس 7B](./Lesson7B.md)  
...
2. **Message Switching** — Explore message forwarding, node processing time, ACK/NACK system, and the store-and-forward mechanism. — [🔗 View Lesson 2](./Lesson2.md)  
...
4. **Switching Review, Virtual Circuits, Datagrams, and Signals** — A review of switching concepts and introduction to signals in networks. — [🔗 View Lesson 4](./Lesson4.md)  
5. **Transmission Media, Waves, Wireless Propagation** — Covers physical media, wave behavior, and wireless communication principles. — [🔗 View Lesson 5](./Lesson5.md)  
